...
import com.wpz.community.service.MessageService;
...
//        Integer.valueOf("abc"); // 造错测试, 500
    ...
    public String sendLetter(String toName, String content){
        ...
        return CommunityUtil.getJSONString(0); // 如果没有异常就直接给页面发送一个0即可
    }
